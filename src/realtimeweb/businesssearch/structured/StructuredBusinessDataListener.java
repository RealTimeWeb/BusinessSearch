 ...
 * a Map containing all the information about the Business will be passed to the
 * businessDataCompleted method, which must be overridden in any implementing
 * classes. On failure, an exception is passed to the businessDataFailed method,
